...
const NODE_COLORS = {
  ...
  CTRC:       { bg:'#001a2e', border:'#3399ff', font:'#b0d8ff' },
  CONHE:      { bg:'#001a2e', border:'#66b2ff', font:'#cce5ff' },
  CONTRATO:   { bg:'#1a002e', border:'#9966ff', font:'#ddc8ff' },
  RPA:        { bg:'#2e1a00', border:'#ff9933', font:'#ffd9a8' },
